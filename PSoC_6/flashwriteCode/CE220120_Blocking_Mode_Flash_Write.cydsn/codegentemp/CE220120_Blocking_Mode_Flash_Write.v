// ======================================================================
// CE220120_Blocking_Mode_Flash_Write.v generated from TopDesign.cysch
// 10/28/2021 at 11:32
...
module top ;
	...
	wire [0:0] tmpFB_0__LED_ERROR_net;
	wire [0:0] tmpIO_0__LED_ERROR_net;
	electrical [0:0] tmpSIOVREF__LED_ERROR_net;
	...
	cy_mxs40_gpio_v1_0
		...
		LED_ERROR
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_ERROR_net[0:0]}),
		  .io({tmpIO_0__LED_ERROR_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_ERROR_net),
		  .annotation({Net_3}));
