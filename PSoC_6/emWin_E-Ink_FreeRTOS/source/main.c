...
#define EINK_TASK_PRIORITY          (configMAX_PRIORITIES - 2)
#define MOTION_TASK_STACK_SIZE        (1024*10)
#define MOTION_TASK_PRIORITY          (configMAX_PRIORITIES - 3)
...
int main(void)
{
    ...
    motionDataQueue = xQueueCreate(1,sizeof(mtb_bmi160_data_t));


    if( motionDataQueue == NULL )
    {
    ...
    xTaskCreate(motion_task, "Motion Sensor Taks", MOTION_TASK_STACK_SIZE,
            NULL,  MOTION_TASK_PRIORITY,  NULL);
